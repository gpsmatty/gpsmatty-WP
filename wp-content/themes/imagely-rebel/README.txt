...
Theme Page: www.imagely.com/wordpress-photography-themes/rebel
Theme Documentation: www.imagely.com/docs/rebel
Theme License: GPL-2.0+

INSTALLATION

Imagely Rebel is a Genesis child theme. You will need to have the Genesis 
...
= 1.0.7 = 
* New: Completed Imagely Beckstead theme
* New: Full width template for blog posts
* Fixed: Extra 'protected' message appearing on password protected pages

= 1.0.8 = 
* New: Completed Imagely Limitless theme
* New: Completed Imagely Gridly theme
* Changed: Improved mobile styling for front page featured page/post widgets
* Fixed: Mispelling of "Imagegy" vs "Imagely" in Lightly theme
